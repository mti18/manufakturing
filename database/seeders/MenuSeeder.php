    ...
    public function run()
    {
        ...
        $menus = [
            ...
            ['auth' => true, 'level' => ['admin', 'user'], 'children' => [
                ...
                ['id' => 65, 'name' => 'Hutang Piutang', 'url' => '/hutangpiutang', 'route' => 'dashboard.hutangpiutang', 'component' => 'hutangpiutang/Index', 'icon' => 'fas fa-money-check-alt fs-2'],
                ...
                ['id' => 45, 'name' => 'Jurnal Laporan', 'route' => 'dashboard.master.jurnallaporan', 'icon' => 'fas fa-book fs-2', 'children' => [
                    ...
                    ['id' => 60, 'name' => 'Stok Barang', 'route' => 'dashboard.master.jurnallaporan.stokbarang', 'icon' => 'fas fa-circle fa-xs', 'children' => [
                            ['id' => 61, 'name' => 'Laporan Barang Jadi', 'url' => '/master/jurnallaporan/stokbarang/laporanbarangjadi', 'route' => 'dashboard.master.jurnallaporan.stokbarang.laporanbarangjadi', 'icon' => 'fas fa-circle fa-xs', 'component' => 'master/jurnallaporan/stockbarang/stockjadi/Index'],
                            ['id' => 62, 'name' => 'Laporan Barang Mentah', 'url' => '/master/jurnallaporan/stokbarang/laporanbarangmentah', 'route' => 'dashboard.master.jurnallaporan.stokbarang.laporanbarangmentah', 'icon' => 'fas fa-circle fa-xs', 'component' => 'master/jurnallaporan/stockbarang/stockmentah/Index'],
                        ],
                    ],
                    ],
                ],
