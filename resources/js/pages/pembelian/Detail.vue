<template>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="mb-8">
              ...
              <input type="text" name="bukti_permintaan" id="bukti_permintaan" placeholder="Bukti Pemasanan"  
  ...
  export default {
    ...
    methods: {
      ...
      var vm = this;
      var index = app.suppliers.findIndex((cat) => cat.id==e);
      this.form.suppliers_id = this.suppliers[index].nama;
      var myString = this.form.supplier_id;
