      ...
      <div class="row">
        <div class="col-6">
          ...
          <div class="mb-8">
            ...
            <div class="input-group">
              <div class="input-group-prepend"><span class="input-group-text">Rp</span></div> 
                <money3 type="text" name="total" id="total" v-bind="config"
          ...
          <div class="mb-8">
            ...
            <div class="input-group">
              <div class="input-group-prepend"><span class="input-group-text">Rp</span></div> 
                <money3 type="text" name="totalbayar" id="totalbayar" v-bind="config"
                  class="form-control" required autoComplete="off" v-model="form.total" />
            </div>
          </div>
        </div>
        <div class="col-6">
          ...
          <div class="mb-8">
            ...
            <div class="input-group">
              <div class="input-group-prepend"><span class="input-group-text">Rp</span></div> 
                <money3 type="text" name="sisabayar" id="sisabayar" v-bind="config"
        ...
        <div class="col-12">
          <div class="mb-8">
            ...
            <div class="input-group">
              <div class="input-group-prepend"><span class="input-group-text">Rp</span></div> 
                <money3 type="text" name="bayar" id="bayar" v-bind="config"
  ...
  setup({ selected }) {
    ...
    const { mutate: submit } = useMutation(
      (data) =>
        axios
          .post(
            selected ? `/pembayaran/${selected}/update` : "/pembayaran/store",
            data
          )
          .then((res) => res.data),
      {
    ...
    onSubmit() {
      ...
      this.submit(data, {
        onSuccess: (data) => {
          ...
          vm.queryClient.invalidateQueries(["/pembayaran/paginate"], {
            exact: true,
          });
        },
      });
