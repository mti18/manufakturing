    ...
    <div class="card-body">
      <div class="row">
        <div class="col-4">
          ...
          <file-upload
            :files="selected && form?.avatar ? `/${form.avatar}` : file"
        ...
        <div class="col-8">
          <div class="row">
            ...
            <div class="col-6">
              <div class="mb-8">
                <label for="whatsapp" class="form-label required">
                  Whatsapp :
                </label>
                <input
                  type="text"
          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="mb-8">
                <label for="user_group_uuid" class="form-label required">
                  User Group :
                </label>
                <select2
                  class="form-control"
            ...
            <div class="col-4">
              <div class="mb-8">
                <label for="position_uuid" class="form-label required">
                  Jabatan :
                </label>
                <select2
                  class="form-control"
...
export default {
  ...
  setup({ selected }) {
    ...
    const { mutate: submit } = useMutation(
      (data) =>
        axios
          .post(selected ? `/user/${selected}/update` : "/user/store", data)
          .then((res) => res.data),
      {
        onMutate: () => {
    ...
    const { data: userGroups } = useQuery(
      ["user-groups"],
      () => axios.get("/user-group/get").then((res) => res.data),
      {
        placeholderData: [],
      }
    );
    ...
    const { data: positions } = useQuery(
      ["positions"],
      () => axios.get("/position/get").then((res) => res.data),
      {
        placeholderData: [],
      }
    );
