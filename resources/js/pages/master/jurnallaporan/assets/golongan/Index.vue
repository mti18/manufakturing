<template>
    <section>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <mti-paginate id="table-position" url="/golongan/paginate" :columns="columns"></mti-paginate>
        </div>
      </div>
    </section>
  </template>
  ...
  export default {
    ...
    setup() {
      ...
      const { delete: deleteGolongan } = useDelete({
        onSuccess: () => {
          queryClient.invalidateQueries(["/golongan/paginate"]);
        }
      })
